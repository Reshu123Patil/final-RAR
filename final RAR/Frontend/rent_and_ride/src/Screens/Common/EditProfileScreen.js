...
const EditProfileScreen = (props) => {
    ...
    useEffect(()=>{
        ...
        if(response && response.status === 200){
            ...
            dispatch(signout())
            toast.success('Profile Updated Successfully !!! Logging out for saving changes')
                ...
                <div className="row">
                   ...
                   <div className="row">
                        ...
                        <div className="mb-3">
                                ...
                                <input defaultValue={null} onChange={(e)=>{setPassword(e.target.value)}} type="password" className="form-control"  placeholder=""></input>
                   ...
                   <div className="row">
                    ...
                    <div className="mb-3 float-start">
                                <button onClick={onEditProfile} type="button" className="btn btn-success">Edit</button>
                    </div>
