...
var price = location && location.state !== null ? location.state.carData.price : 1000;
    ...
    const onPaymentInitiation = () => {
      navigate("/CarListScreen")
        const url = "http://localhost:8081/RentAndRide/user/payment";
            ...
            <div className="row">
                ...
                <div className="col-md-6">
                    ...
                    <div className="mb-3 float-start">
                                <button onClick={onPaymentInitiation} type="button"  Link to="/manage-booking" className="btn btn-outline-primary">Initiate Payment</button>
                        </div>
